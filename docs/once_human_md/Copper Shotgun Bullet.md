...
How To Get[]
The recipe for Copper Shotgun Bullet is unlocked via the Cradle under the Crafting page, 01 Awakening. The memetic, Ammunition I, costs 1 cipher and  0body[data-theme="light"] .mw-parser-output .energy-links-icon{filter:drop-shadow(0 0 0.125em black)}.

How To Craft[]
Copper Shotgun Bullet can be crafted at any Supplies Workbench.
