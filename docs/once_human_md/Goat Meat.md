...
How To Get[]
Goat Meat can be harvested from slain animals of the goat variety (Ram, Ewe, etc.)

How To Use[]
Goat Meat is used as an input in the following formulas:
...
Tips[]
When used in various Kitchen formulas they grant an additional status effect Slow Recovery, which "Restores HP Slowly".
