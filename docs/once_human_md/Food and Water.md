...
2 List of Craftable Food and Drinks
3 Replaceable Ingredients

3.1 Meat Substitutions
3.2 Flower Substitutions

3.2.1 Deviated Flower Substitutions


3.3 Fish Substitutions

3.3.1 Grilled Fish Substitutions
...
Food and drinks are consumables required for the player's character to perform at their best. Food and drinks replenish "Hydration" and/or "Energy", and sometimes, "Sanity" bars when consumed. The first two bars decrease on their own with some time (except for cases mentioned down below), while Sanity will deplete in some places, or after being attacked by some enemies. 
Some food may give buffs depending on the ingredient used and can be buffed using certain Memetic Specializations.

Energy[]
 	 	 	 		 			 		 		 		 			Appearance of buff "Filled up" 		 	 
The bar "Energy" represents saturation of the player. Depending on the value, one can have buffs or debuffs correspondingly, that will change immediately as value of parameter change. There are 4 possible cases: 

60%~100%: HP +400; Melee Weapon DMG +10%; No natural Energy loss for 20 mins when Hydration is maxed out.
30%~60%: HP +200.
0%~30%: Load -10.
0%: Load -20.
Hydration[]
The bar "Hydration" represents the degree of hydration of the player. Hydration depletes faster than Energy. As with food, depending on the value, players can have buffs or debuffs correspondingly, that will change as the value of the parameter changes. There are 4 possible cases: 

60%-100%: Sprint Speed +20%; Sprint Stamina Cost -50%; No natural Hydration loss for 20 minutes when hydration is maxed out.
30%-60%: Sprint Speed +10%.
0%-30%: Stamina Recovery Speed -50%; Movement Speed -10%.
0%: Stamina Recovery Speed -70%; Movement Speed -20%.
There are plenty of different types of food and drink which restore Sanity, Energy, HP, or provide buffs. Most foods can be crafted using a Stove, Electric Stove, or Kitchen Set.

Ingredients[]
Some food items cannot be consumed directly, but are instead only useful as ingredients. Food items that are only useful as ingredients include:
...
Salt
Sugar
On the other hand, players can find vegetables, fruits, herbs and grains in the wilderness. All of these can be eaten for some small Energy and/or Hydration replenishment.

Vegetables[]
Cabbage (Energy +5, Hydration +5)
Cactus (Energy +5, Sanity -100)
Morel (Energy +5)
Mushroom (Energy +5)
Onion (Energy +10)
Polar Pepper (Energy +5)
Potato (Energy +5)
Pumpkin (Energy +5)
Snow Fungus (Energy +5)
Tomato (Energy +10)
Fruits[]
Aloe Vera (Energy +5)
Apple (Energy +10, Hydration +10)
Banana(Energy +10, Hydration +10)
Beet (Energy +5)
Blueberry (Energy +5, Hydration +5)
Coconut (Hydration +15)
Grapes (Energy +10, Hydration +10)
Hawthorn Berry (Energy +5, Hydration +5)
Ice Melon (Energy +5)
Orange (Energy +10, Hydration +10, Sanity -100)
Peppercorn (N/A)
Spikemato (Energy +5)
Herbs[]
Bellflower (Energy +5)
Coneflower (Energy +5)
Honeysuckle (Energy +5)
Mint (Energy +5)
Saffron (Energy +5)
Sage (Energy +5)
Scarlet Calamus (Energy +5)
Sunny Ginger (Energy +5)
Yellow Lotus (Energy +5)
Grains[]
Corn (Energy +5)
Wheat (Energy +5)
Note: Each of them can be used to create some other food, or used in advanced recipes.

List of Craftable Food and Drinks[]
...
When crafting some recipes there will be a prompt for the player to substitute an ingredient, such as using different kinds of meat, fish and flowers when cooking. This is because various different types of ingredients will give different buffs/effects.

Meat Substitutions[]
Bear Meat (Max HP  +100)
Beast Meat, Raw Meat (no effect)
Beef (Gradually restores Stamina when  not in combat)
Crocodile Meat (Pollution Resist +5%)
Deer Meat (Max stamina +25)
Fine Turtle Meat (Stamina Recovery  Speed +50%, Dish bonus effect duration +50%)
Goat Meat, Poultry Meat (Gradually  restores HP when not in combat)
Pork (Max HP +50)
Pristine Bear Meat (Max HP +15%, Dish  bonus effect magnitude +20%)
Pristine Beast Meat (Pollution Resist  +30%, Dish bonus effect duration +50%)
Pristine Beef (Quickly restores Sanity  when not in combat)
Pristine Crocodile Meat (Pollution  Resist +30%, Dish bonus effect magnitude +20%)
Pristine Deer Meat, Pristine Rabbit  Meat (Max Stamina +100, Dish bonus effect duration +50%)
Pristine Goat Meat (Recover 3% Max HP  per second when not in combat, Dish bonus effect duration +50%)
Pristine Pork (Max HP +15%, Dish bonus  effect duration +50%)
Pristine Poultry (Recover 3% Max HP  per second when not in combat, Dish bonus effect magnitude +20%)
Pristine Turtle Meat (Stamina Recovery  Speed +50%, Dish bonus effect magnitude +20%)
Rabbit Meat (Max stamina +40)
Snapping Turtle (Pollution Resist  +10%)
Turtle Meat, Horse Meat (Stamina  Recovery Speed +20%)
Flower Substitutions[]
Bellflower (Dish  bonus effect +10%)
Coneflower (Restores sanity)
Honeysuckle (Restores Healing)
Saffron (Max Stamina +3%)
Sage (Dish bonus effect duration +10%)
Scarlet Calamus (Dish Weight -50%)
Yellow Lotus (Dish durability +20%)
Deviated Flower Substitutions[]
Deviated Bellflower (Dish bonus effect +20%)
Deviated Coneflower (Restores sanity)
Deviated Honeysuckle (Restores  Healing)
Deviated Saffron (Max Stamina +?%)
Deviated Sage (Dish bonus effect  duration +35%)
Deviated Scarlet Calamus (Dish Weight  -100%)
Deviated Yellow Lotus (Dish durability  +50%)
Fish Substitutions[]
Angelfish (Crit  DMG + 5%)
Arowana (Swim speed +15%)
Barracuda (Psi Intensity +5%)
Bighead carp (Logging speed +10%)
Most/all other fish (Load +10%)
Oscarfish (Load +15%)
Pompano (Weakspot DMG +5%)
Sea Bass (Fire Rate +10%)
Sucker Fish (Swim speed +10%)
Sunfish (Mining Speed +10%)
Tilapia (Mining Speed +15%)
Grilled Fish Substitutions[]
Largemouth Black  Bass (Durability +50%)
Longnose Gar (Item Weight +500%??)
Mackerel (Energy +50, Hydration -100)
Northern Pike (Durability +100)
Rainbow Trout (Cooldown Time -50%)
Salmon ("Won't spoil")
Sardine (Energy +500%, Hydration -50%)
Trivia[]
Animal feed is unaffected
Deviated peppercorns somehow "buff" Hug-in-a-bowl
Different kinds of water or milk appear to have no changes
Recipes which require a specific item which could normally cause a change will not give the change
