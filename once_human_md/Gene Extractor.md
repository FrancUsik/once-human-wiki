...
Gene Extractor
	...
	14d
	 ...
	 300body[data-theme="light"] .mw-parser-output .energy-links-icon{filter:drop-shadow(0 0 0.125em black)} N/Abody[data-theme="light"] .mw-parser-output .astral-sand-icon{filter:drop-shadow(0 0 0.125em black)}
	...
	Status Effects:Gene Extraction While carrying this item in your backpack, you gain the effect: Defeating Deviants grants gene fragments based on enemy types.
	...
	Crafted:Advanced Supplies WorkbenchMemetic Specialization:Judgment Coherence Injection
...
How To Get[]
Crafting Gene Extractor requires the Memetic Specialization Judgment Coherence Injection.

Crafting[]
Gene Extractor can be crafted on an Advanced Supplies Workbench:
...
How To Use[]
Gene Extractor is a passive tool, as long as it is present in your backpack you will gain its effects.
