...
How To Use[]
Note: Unlike the Medium/Large Garage, the Garage itself displays a static model of the player's currently activated vehicle. The static model remains even after the player spawns their currently activated vehicle in.
