...
How To Get[]
The recipe for Copper LMG Ammo is unlocked via the Cradle under the Crafting page, 01 Awakening. The memetic, Ammunition I, costs 1 cipher and  0body[data-theme="light"] .mw-parser-output .energy-links-icon{filter:drop-shadow(0 0 0.125em black)}.

How To Craft[]
Copper LMG Ammo can be crafted at any Supplies Workbench.
...
For MG4 and KVD light machine guns.
