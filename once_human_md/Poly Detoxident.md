...
How To Get[]
Loot / Rewards[]
Poly Detoxident is random chance loot from defeated enemies, and is occasionally found in crates and containers throughout Nalcott.

Disassembly[]
Poly Detoxident can be obtained by disassembling the following items:

	
		Rescue Bot
	
How To Use[]
Poly Detoxident is used as an input when crafting the following items:
